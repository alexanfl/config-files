...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Clock = __webpack_require__(68);

	var _Clock2 = _interopRequireDefault(_Clock);

	var _Weather = __webpack_require__(69);

	var _Weather2 = _interopRequireDefault(_Weather);

	var _RssFeed = __webpack_require__(70);

	var _RssFeed2 = _interopRequireDefault(_RssFeed);

	var _RssFeedsContainer = __webpack_require__(71);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _objectAssignDeep = __webpack_require__(37);
	...
	var Container = function (_React$Component) {
	    ...
	    function Container(props) {
	        ...
	        var childrenProps = props.config.childrenProps;
	        if (childrenProps && (0, _Utils.isObject)(childrenProps)) {
	            var _props = childrenProps.props || {};
	            var method = childrenProps.method === 'deepAssign' ? _objectAssignDeep2.default : _assign;
	            var comps = _this.props.config.components;
	            if (comps && Array.isArray(comps)) {
	                for (var comp in comps) {
	                    method(comps[comp], _props);
	                }
	            }
	        }
	    ...
	    _createClass(Container, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            if (this.props.config.events && this.props.config.events.onMount) {
	                ...
	                _LoggerService2.default.debug(this.props.config.events.onMount.name, [_assign({}, this.props.config.events.onMount, { selected: this.props.config.selected })]);
	            }
	        }
	    }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FilesService = __webpack_require__(41);
	    ...
	    switch (behaviour.do) {
	        ...
	        case ActionTypes.CHANGE_SELECTED:
	            retFunc = function retFunc(args) {
	                ...
	                if (this.selected != selected) {
	                    ...
	                    _EventsService2.default.trigger(_Consts.AUTO_SUGGEST_SELECTED_CHANGE_EVENT, [_assign({}, args, { text: self.state.rows[selected] })]);
	        ...
	        case ActionTypes.VALIDATE_FILES_TYPES:
	            retFunc = function retFunc() {
	                ...
	                if ((!allowedTypes || !Array.isArray(allowedTypes)) && !maxAllowedSize && !maxAllowedLength) {
	                    _EventsService2.default.trigger(events["success"], [_assign({}, args, { fileName: files[0]["name"], files: files })], true);
	                    return;
	                }

	                if (maxAllowedLength && files.length > maxAllowedLength) {
	                    _EventsService2.default.trigger(events["amount"], [_assign({}, args, { fileName: files[0]["name"], files: files })], true);
	                    return;
	                }
	                    ...
	                    if (file !== "length" && file !== "item") {
	                        if (allowedTypes) {
	                            if (!allowedTypes.includes(files[file].type)) {
	                                validate = false;
	                                _EventsService2.default.trigger(events["type"], [_assign({}, args, { fileName: files[0]["name"], files: files })], true);
	                            }
	                        }
	                        if (maxAllowedSize && validate) {
	                            if (files[file].size > maxAllowedSize) {
	                                validate = false;
	                                _EventsService2.default.trigger(events["size"], [_assign({}, args, { fileName: files[0]["name"], files: files })], true);
	                            }
	                        }
	                ...
	                if (validate) _EventsService2.default.trigger(events["success"], [_assign({}, args, { fileName: files[0]["name"], files: files })], true);
	            };
	            break;
	        ...
	        case ActionTypes.SET_CONFIG:
	            retFunc = function retFunc(args) {
	                ...
	                if (cond === null || cond && cond.check(args)) {
	                    if (typeof self.setConfig !== 'function') return;
	        ...
	        case ActionTypes.UPDATE_WEATHER:
	            retFunc = function retFunc() {
	                ...
	                try {
	                    ...
	                    var unit = args.unit || prefUnit === '{{UNITS_WEATHER}}' ? 'metric' : prefUnit;
	        ...
	        case ActionTypes.TRACK:
	            retFunc = function retFunc() {
	                ...
	                if (cond === null || cond.check(args, behaviour)) {
	                    ...
	                    var eventType = behaviour.eventType || args.eventType || 'missingEvt';
	                    var delay = behaviour.delay || args.delay || 0;
	                    setTimeout(function () {
	                ...
	                if ((cond === null || cond && cond.check(args, behaviour)) && url != '') {
	                        ...
	                        if (behaviour.removeNewTab || behaviour.removeCurrentTab) {
	                            _BrowserService2.default.getLastFocusedWindow().then(function (windowDetails) {
	                                _BrowserService2.default.getCurrentVisibleTab(windowDetails).then(function (tab) {
	                                    ...
	                                    tracking.trackStatusEvent(_Consts.ERROR_TRACK_EVENT, e.message, e.lineNumber + ' @OPEN_WEB_PAGE3@COMP');
	                                });
	                            });
	                        }
	                    };
	                    ...
	                    if ((typeof windowFeatures === "undefined" ? "undefined" : _typeof(windowFeatures)) === 'object') {
	                        try {
	                            ...
	                            tracking.trackStatusEvent(_Consts.ERROR_TRACK_EVENT, e.message, e.lineNumber + '@OPEN_WEB_PAGE4@COMP', null, windowFeatures["top"] + "|" + windowFeatures["left"]);
	                        }
	                    }
	                    ...
	                    if (args && args.hasOwnProperty('updateTab') && args.updateTab == true || behaviour.hasOwnProperty('updateTab') && behaviour.updateTab == true) {
	                        setTimeout(function () {
	                            _BrowserService2.default.getLastFocusedWindow().then(function (windowDetails) {
	                                _BrowserService2.default.getCurrentVisibleTab(windowDetails).then(function (tab) {
	                                    ...
	                                    tracking.trackStatusEvent(_Consts.ERROR_TRACK_EVENT, e.message, e.lineNumber + ' @OPEN_WEB_PAGE2@COMP');
	                                });
	                            });
	                            removeTab();
	                        }, delay);
	                        ...
	                        if ((typeof windowFeatures === "undefined" ? "undefined" : _typeof(windowFeatures)) === 'object') {
	                            try {
	                                ...
	                                windowFeatures = '';
	                                tracking.trackStatusEvent(_Consts.ERROR_TRACK_EVENT, e.message, e.lineNumber + '@OPEN_WEB_PAGE@COMP');
	                            }
	                        }
	                        setTimeout(function () {
	                ...
	                if (cond === null || cond && cond.check(args)) {
	                    ...
	                    if (behaviour.dynamic && Array.isArray(behaviour.dynamic)) {
	                        ...
	                        for (var elem in behaviour.dynamic) {
	                            ...
	                            events = events.replace(regex, str);
	                        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Addons = __webpack_require__(43);
	var Color = __webpack_require__(54);
	var Display = __webpack_require__(45);
	var GlobalStylesheets = __webpack_require__(48);

	var assign = __webpack_require__(5);
	var createCSS = __webpack_require__(50);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Flex = __webpack_require__(44);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(45).Flex;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CSSDisplayNames = __webpack_require__(46);
	var makeStyleComponentClass = __webpack_require__(47);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var explodePseudoStyles = __webpack_require__(49);
	var createCSS = __webpack_require__(50);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FirstChild = __webpack_require__(58);
	...
	var Input = function (_React$Component) {
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            ...
	            var style = this.state.focus && this.props.config.focusStyle && Object.keys(this.props.config.focusStyle).length > 0 ? this.props.config.focusStyle : _assign({}, this.props.config.style, this.state.style);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Iframe = function (_React$Component) {
	    ...
	    function Iframe(props) {
	        ...
	        // this.iframe = <iframe src={this.state.iframeSettings["src"] || ''}
	        //                       width={this.state.iframeSettings["width"] || "300px"}
	        //                       height={this.state.iframeSettings["height"] || "300px"}
	        //                       frameBorder={this.state.iframeSettings["frameBorder"] || "0"}
	        //                       scrolling={this.state.iframeSettings["scrolling"] || "no"}/>;
	    ...
	    _createClass(Iframe, [{
	        ...
	        value: function render() {
	            ...
	            var html = React.createElement(Block, { style: { display: "none" } });
	            if (this.props.config.hide) return html;
	            var iframeSettings = this.props.config.iframeSettings;
	            var iframeHtml = React.createElement("iframe", { src: iframeSettings["src"] || '',
	        ...
	        value: function setConfig(config) {
	            ...
	            var newConfig = _assign({}, this.props.config, config || {});
	            if (!(0, _Utils.areObjectsEqual)(newConfig, oldConfig)) {
	                _assign(this.props.config, config || {});
	...
	var Maps = function (_React$Component) {
	    ...
	    _createClass(Maps, [{
	        ...
	        value: function getCurrentIframe() {
	            ...
	            var that = this;
	            var html = Object.keys(this.iframes).map(function (componentKey) {
	                return React.createElement(
	                    'div',
	        ...
	        value: function updateIframes(forceParams) {
	            ...
	            this.state.shouldUpdateIframes = false;
	        ...
	        key: 'componentWillUpdate',
	        value: function componentWillUpdate(nextProps) {
	            // if (this.state.shouldUpdateIframes)
	            // this.updateIframes();
	        }
	    }, {
	        key: 'render',
	...
	var Image = function (_React$Component) {
	    ...
	    _createClass(Image, [{
	        ...
	        value: function render() {
	            ...
	            // childImage = !this.props.config.svg ? childImage : <svg onClick={this.handleClick} style={style}> {this.props.config.svg} </svg>;
